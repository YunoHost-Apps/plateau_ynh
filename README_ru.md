...
> *Этот пакет позволяет Вам установить Plateau быстро и просто на YunoHost-сервер.*  
...
**Поставляемая версия:** 2.0.0b~ynh4

**Демо-версия:** <https://plateau.latelier-des-chercheurs.fr>
## Документация и ресурсы

- Официальный веб-сайт приложения: <https://latelier-des-chercheurs.fr>
- Репозиторий кода главной ветки приложения: <https://github.com/l-atelier-des-chercheurs/PLATEAU>
- Магазин YunoHost: <https://apps.yunohost.org/app/plateau>
- Сообщите об ошибке: <https://github.com/YunoHost-Apps/plateau_ynh/issues>

## Информация для разработчиков

Пришлите Ваш запрос на слияние в [ветку `testing`](https://github.com/YunoHost-Apps/plateau_ynh/tree/testing).
